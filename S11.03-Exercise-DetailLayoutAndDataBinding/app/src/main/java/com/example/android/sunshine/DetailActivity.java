...
//      TODO (8) Use mDetailBinding to display the date
        mActivityDetailBinding.primaryWeatherInfo.date.setText(dateText);
        ...
        int resId = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
        mActivityDetailBinding.primaryWeatherInfo.weatherIcon.setImageResource(resId);
        
        /* Use the weatherId to obtain the proper description */
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherId);
        mActivityDetailBinding.primaryWeatherInfo.weatherDescription.setText(description);
...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mActivityDetailBinding.primaryWeatherInfo.maxTemp.setText(highString);
...
//      TODO (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mActivityDetailBinding.primaryWeatherInfo.minTemp.setText(lowString);
...
//      TODO (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mActivityDetailBinding.extraWeatherDetail.humidity.setText(humidityString);
...
//      TODO (13) Use mDetailBinding to display the wind and set the content description
        ...
        mActivityDetailBinding.extraWeatherDetail.wind.setText(windString);
...
//      TODO (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mActivityDetailBinding.extraWeatherDetail.pressure.setText(pressureString);
