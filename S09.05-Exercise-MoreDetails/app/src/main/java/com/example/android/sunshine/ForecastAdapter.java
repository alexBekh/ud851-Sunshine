...
//      TODO (36) Refactor onClick to accept a long as its parameter rather than a String
        void onClick(long normalizedDate);
    }
...
//          TODO (37) Instead of passing the String for the clicked item, pass the date from the cursor
            ...
            final long normalizedDate = mCursor.getLong(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DATE));
            mClickHandler.onClick(normalizedDate);
        }
    }
}