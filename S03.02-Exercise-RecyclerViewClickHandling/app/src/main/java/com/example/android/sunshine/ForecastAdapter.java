...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    final private ForecastAdapterOnClickHandler mForecastAdapterOnClickHandler;
    ...
    public interface ForecastAdapterOnClickHandler
    {
        ...
        void onForecastClick(int forecastIndex);
    }
    ...
    public ForecastAdapter(ForecastAdapterOnClickHandler forecastAdapterOnClickHandler) {
        ...
        mForecastAdapterOnClickHandler = forecastAdapterOnClickHandler;
    }
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            mForecastAdapterOnClickHandler.onForecastClick(index);
        }
    }
