...
//  TODO (5) Within bools.xml in the portrait specific directory, add a bool called use_today_layout and set it to false
    ...
    public static final int FUTURE_DAY_VIEW = 0;
    public static final int TODAY_VIEW = 1;
...
//      TODO (14) Otherwise, throw an IllegalArgumentException
        ...
        {
            case TODAY_VIEW:
                listItemLayout = R.layout.forecast_list_item_today;
                break;
            case FUTURE_DAY_VIEW:
                listItemLayout = R.layout.forecast_list_item;
                break;
            default:
...
//      TODO (11) Otherwise, return the ID for future day viewType
    ...
    {
        return (position == 0 && mUseTodayLayout) ? TODAY_VIEW : FUTURE_DAY_VIEW;
    }
